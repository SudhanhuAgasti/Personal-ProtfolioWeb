    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
          ...
          >
            I'm <span className="text-foreground font-medium">Shradha Suman Das</span> — an Aspiring
            Front-End Web Developer & Software Tester crafting clean, responsive, and intuitive web
            experiences!!
          </motion.p>
          ...
          >
            ...
            <MagneticButton
              as="a"
              href="/shradha_resume.pdf"
              download="Shradha_Suman_Das_Resume.pdf"
          ...
          >
            ...
            <div>
              <span className="block text-2xl font-semibold text-foreground">2+</span>Projects
            </div>
            <div className="h-8 w-px bg-white/10" />
            <div>
              <span className="block text-2xl font-semibold text-foreground">1</span>Hackathon
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="glass-strong relative overflow-hidden rounded-[2rem] p-6 glow-violet">
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              ...
              <span className="font-mono">shradha.dev</span>
            </div>
            <div className="relative mt-4 aspect-square overflow-hidden rounded-2xl">
              <img
                src={heroOrb}
                alt="Iridescent 3D orb representing Shradha's design aesthetic"
                width={1024}
                height={1024}
            ...
            <div className="mt-4 rounded-xl bg-black/40 p-4 font-mono text-[11px] leading-relaxed">
              ...
              <span className="text-emerald-300">"Shradha Suman Das"</span>,
              <br />
              &nbsp;&nbsp;<span className="text-muted-foreground">stack:</span>{" "}
              <span className="text-amber-300">["HTML5", "CSS3", "JavaScript", "Testing"]</span>,
              <br />
              &nbsp;&nbsp;<span className="text-muted-foreground">focus:</span>{" "}
              <span className="text-emerald-300">"clean code + usability"</span>
              <br />
              {"}"}
            </div>
          </div>
