...
const skills: Skill[] = [
  {
    ...
    icon: Layout,
    items: ["HTML5", "CSS3", "JavaScript (Basic)", "Responsive Web Design", "UI Layout Design"],
    level: 90,
  ...
  },
  {
    title: "Databases",
    icon: Database,
    items: ["SQL", "Oracle (Basic queries)"],
    level: 80,
  ...
  },
  {
    ...
    icon: Wrench,
    items: ["Git (Basic)", "Visual Studio Code", "JIRA (Basic awareness)"],
    level: 82,
    accent: "var(--neon-cyan)",
  },
  {
    ...
    icon: Code,
    items: ["C", "C++", "Java (Basic)", "Spring Boot", "Python (Basic)"],
    level: 78,
    accent: "var(--neon-violet)",
  },
  {
